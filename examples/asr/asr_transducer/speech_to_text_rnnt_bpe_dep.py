...
from nemo.collections.asr.models.rnnt_bpe_models_dep import EncDecRNNTBPEModel_dep
from nemo.core.config import hydra_runner
from nemo.utils import logging
from nemo.utils.exp_manager import exp_manager


@hydra_runner(config_path="/home/jykang/NeMo/examples/asr/conf/conformer/tdt", config_name="conformer_tdt_bpe_stateless_dep")
def main(cfg):
    logging.info(f'Hydra config: {OmegaConf.to_yaml(cfg)}')

    trainer = pl.Trainer(**cfg.trainer)
    exp_manager(trainer, cfg.get("exp_manager", None))
    asr_model = EncDecRNNTBPEModel_dep(cfg=cfg.model, trainer=trainer)
