...
class TranscriptionConfig:
    ...
    # model_path: Optional[str] = '/data/jykang/NeMo/nemo_experiments/Conformer-CTC-BPE-Fitnet-AddLayer/2024-04-02_16-24-25/checkpoints/Conformer-CTC-BPE-Fitnet-AddLayer/2024-04-02_16-24-25.nemo'
    model_path: Optional[str] = '/data/jykang/NeMo/nemo_experiments/Conformer-CTC-BPE-Fitnet-AddTeEnc/2024-03-30_14-15-20/checkpoints/Conformer-CTC-BPE-Fitnet-AddTeEnc.nemo'
...
def main(cfg: TranscriptionConfig) -> Union[TranscriptionConfig, List[Hypothesis]]:
    ...
    # te_weights = torch.load('/data/jykang/NeMo/data/encoder/17_layer_weights.pt')
