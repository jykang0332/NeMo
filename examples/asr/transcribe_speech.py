...
class TranscriptionConfig:
    ...
    model_path: Optional[str] = "/data/jykang/NeMo/nemo_experiments/Conformer-CTC-BPE-DPO-frame-aug/2024-07-22_10-42-19/checkpoints/Conformer-CTC-BPE-DPO-frame-aug.nemo"  # Path to a .nemo file
