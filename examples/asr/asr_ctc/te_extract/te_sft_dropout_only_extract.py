...
class TranscriptionConfig:
    ...
    save_path_1 : Optional[str] = "/data/jykang/NeMo/data/softmax_tau/train-other-500"
    save_path_2 : Optional[str] = "/data/jykang/NeMo/data/te_hyp_tau/train-other-500"
    ...
    # General configs
    output_filename: Optional[str] = "/data/jykang/NeMo/data/transcriptions/softmax_tau_train_other_500.json"
    batch_size: int = 48
    num_workers: int = 0
