...
class TranscriptionConfig:
    ...
    # save_path_1 : Optional[str] = "/data/jykang/NeMo/data/softmax_dropout/1/test-other"
    # save_path_2 : Optional[str] = "/data/jykang/NeMo/data/te_hyp_dropout/1/test-other"
    ...
    # General configs
    output_filename: Optional[str] = "/data/jykang/NeMo/data/transcriptions/dropout_sft_test_other.json"
    batch_size: int = 48
    num_workers: int = 0
...
def main(cfg: TranscriptionConfig) -> Union[TranscriptionConfig, List[Hypothesis]]:
    ...
    transcriptions = transcriptions_1
