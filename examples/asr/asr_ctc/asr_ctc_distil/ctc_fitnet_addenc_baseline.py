...
from nemo.collections.asr.models.ctc_bpe_models_Fitnet_AddEnc_baseline import EncDecCTCModelBPE
...
@hydra_runner(config_path="./conf", config_name="conformer_ctc_bpe_Fitnet_AddEnc_baseline")
def main(cfg):
