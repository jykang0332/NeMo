...
from nemo.collections.asr.models.ctc_bpe_models_Fitnet_AddTeEnc import EncDecCTCModelBPE
...
@hydra_runner(config_path="./conf", config_name="conformer_ctc_bpe_Fitnet_AddTeEnc")
def main(cfg):
