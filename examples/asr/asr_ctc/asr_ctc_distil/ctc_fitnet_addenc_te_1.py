...
from nemo.collections.asr.models.ctc_bpe_models_Fitnet_AddTeEnc_1 import EncDecCTCModelBPE
...
@hydra_runner(config_path="./conf", config_name="conformer_ctc_bpe_Fitnet_AddTeEnc_1")
def main(cfg):
    ...
    # te_weights = torch.load('/data/jykang/NeMo/data/encoder/1_layer_weights.pt')
    ...
    with torch.no_grad():
        ...
        #     if 'te_layer' in key:
        #         asr_model.state_dict()[key].copy_(te_weights[key.replace('encoder.te_layer', 'encoder.layers.0')])
