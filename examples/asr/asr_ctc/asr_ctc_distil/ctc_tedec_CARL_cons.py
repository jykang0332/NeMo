...
from nemo.collections.asr.models.ctc_bpe_models_TeDec_CARL_cons import EncDecCTCModelBPE
from nemo.core.config import hydra_runner
from nemo.utils import logging
from nemo.utils.exp_manager import exp_manager


@hydra_runner(config_path="./conf", config_name="conformer_ctc_bpe_Fitnet_TeDec_CARL_Cons")
def main(cfg):
    ...
    asr_model.maybe_init_from_pretrained_checkpoint_TeDec_CARL(cfg)
