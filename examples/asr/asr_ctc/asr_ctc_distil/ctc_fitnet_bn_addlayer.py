...
from nemo.collections.asr.models.ctc_bpe_models_Fitnet_BN_AddLayer import EncDecCTCModelBPE
...
def main(cfg):
    ...
    te_dec_bias = torch.load('/data/jykang/NeMo/data/decoder/medium_te_dec_bias.pt')
    te_dec_weight = torch.load('/data/jykang/NeMo/data/decoder/medium_te_dec_weight.pt')
