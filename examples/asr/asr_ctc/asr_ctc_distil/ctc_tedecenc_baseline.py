...
from nemo.collections.asr.models.ctc_bpe_models_TeDecEnc import EncDecCTCModelBPE
from nemo.core.config import hydra_runner
from nemo.utils import logging
from nemo.utils.exp_manager import exp_manager

import torch
@hydra_runner(config_path="./conf", config_name="conformer_ctc_bpe_Fitnet_TeDecEnc_baseline")
def main(cfg):
    ...
    #         if 'te_layer' in key:
    #             asr_model.state_dict()[key].copy_(te_weights[key.replace('encoder.te_layer', 'encoder.layers.17')])
