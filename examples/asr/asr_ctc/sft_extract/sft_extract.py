...
class TranscriptionConfig:
    # Required configs
    model_path: Optional[str] = "/data/jykang/research_models/NeMo_evid/nemo_experiments/Conformer-CTC-BPE.nemo"  # Path to a .nemo file
    ...
    softmax_path: Optional[str] = '/data/jykang/research_models/NeMo_evid/ctc_feature/student_baseline_sft/train-other-500'
    ...
    # General configs
    output_filename: Optional[str] = "/data/jykang/research_models/NeMo_evid/ctc_feature/transcriptions/stu_train_other_500.json"
    batch_size: int = 32
    num_workers: int = 0
...
def main(cfg: TranscriptionConfig) -> Union[TranscriptionConfig, List[Hypothesis]]:
    ...
    # Restore checkpoint
    ckpt_path = '/data/jykang/research_models/NeMo_evid/nemo_experiments/Conformer-CTC-BPE--val_wer=0.0473-epoch=98.ckpt'
