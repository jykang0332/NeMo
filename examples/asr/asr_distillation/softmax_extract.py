...
class TranscriptionConfig:
    # Required configs
    model_path: Optional[str] = "/home/jykang/NeMo/nemo_experiments/stt_en_conformer_ctc_large_ls.nemo"
    #"/home/jykang/NeMo/nemo_experiments/Conformer-CTC-BPE/checkpoints/Conformer-CTC-BPE.nemo"
     # Path to a .nemo file
    ...
    # General configs
    output_filename: Optional[str] = "/home/jykang/NeMo/data/results/test_clean_stt_en_conformer_ctc_large.json" #None
    batch_size: int = 1
    num_workers: int = 0
    ...
    #ctc_decoding: CTCBPEDecodingConfig = CTCBPEDecodingConfig()

    # Decoding strategy for RNNT models
    rnnt_decoding: RNNTDecodingConfig = RNNTDecodingConfig(fused_batch_size=-1)
    #rnnt_decoding: RNNTBPEDecodingConfig = RNNTBPEDecodingConfig(fused_batch_size=-1)
...
def main(cfg: TranscriptionConfig) -> TranscriptionConfig:
    ...
    for idx, transcription in enumerate(transcriptions):
        softmax = torch.exp(transcription.y_sequence)        
        softmax = softmax.cpu().numpy()
        base_file_name = os.path.basename(filepaths[idx])
        file_name = os.path.splitext(base_file_name)[0]
        path = os.path.join(cfg.softmax_path, file_name)
        np.save(path, softmax) 

        # if file_name == '1235-135884-0034':
        #     print(softmax.shape)

        # if file_name == '7178-34644-0034':
        #     print(softmax.shape)

        # if file_name == '8630-305212-0017':
        #     print(softmax.shape)

        # if file_name == '441-130108-0020':
        #     print(softmax.shape)
        
        # if file_name == '4014-186175-0033':
        #     print(softmax.shape)
