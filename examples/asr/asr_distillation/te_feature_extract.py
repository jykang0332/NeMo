...
from nemo.collections.asr.models.ctc_bpe_models_feature import EncDecCTCModelBPE_feature
...
@hydra_runner(config_path=".", config_name="conformer_ctc_bpe_feature")
def main(cfg):
    logging.info(f'Hydra config: {OmegaConf.to_yaml(cfg)}')

    trainer = pl.Trainer(**cfg.trainer)
    exp_manager(trainer, cfg.get("exp_manager", None))
    asr_model = EncDecCTCModelBPE_feature(cfg=cfg.model, trainer=trainer)
