...
class TranscriptionConfig:
    ...
    # General configs
    output_filename: Optional[str] = "/home/jykang/NeMo/data/transcribe_results/dev_clean_te.json"
    batch_size: int = 1
    num_workers: int = 0
...
def main(cfg: TranscriptionConfig) -> TranscriptionConfig:
    ...
    #     path = os.path.join(cfg.feature_path, filename)
    #     te_feature = te_Lth_feature[idx].cpu().numpy()
    #     np.save(path, te_feature)
