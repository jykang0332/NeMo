...
__all__ = ['ConformerConvolution', 'ConformerFeedForward', 'ConformerLayer_qkv']


class ConformerLayer_qkv(torch.nn.Module, AdapterModuleMixin, AccessMixin):
    ...
    def __init__(
        ...
        lth_layer = 0,
        n_layers = 0,
        qkv_extraction=False,
    ):
        super(ConformerLayer_qkv, self).__init__()
        ...
        # jykang
        # For qkv extraction
        self.qkv_extraction = qkv_extraction
        self.lth_layer = lth_layer
        self.n_layers = n_layers


        if self_attention_model == 'rel_pos':
            self.self_attn = RelPositionMultiHeadAttention_qkv(
                n_head=n_heads,
                n_feat=d_model,
            ...
            self.self_attn = RelPositionMultiHeadAttentionLongformer_qkv(
                n_head=n_heads,
                n_feat=d_model,
                dropout_rate=dropout_att,
                pos_bias_u=pos_bias_u,
            ...
            self.self_attn = MultiHeadAttention_qkv(
