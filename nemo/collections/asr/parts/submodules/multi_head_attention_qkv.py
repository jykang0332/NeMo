...
class MultiHeadAttention_qkv(nn.Module):
    ...
    def __init__(self, n_head, n_feat, dropout_rate, max_cache_len=0):
        ...
        super(MultiHeadAttention_qkv, self).__init__()
        ...
        # jykang
        # self.n_feat = size of the features
        # self.h = number of heads = n_head
        # self.d_k = size of each head = n_feat // n_head
        

    def forward_qkv(self, query, key, value):
        """Transforms query, key and value.
        Divide by the number of heads
        Args:
...
class RelPositionMultiHeadAttention_qkv(MultiHeadAttention_qkv):
