...
def resolve_rnnt_loss_dep(loss_name: str, blank_idx: int, loss_kwargs: dict = None) -> torch.nn.Module:
    ...
    def __init__(self, num_classes, reduction: str = 'mean_batch', loss_name: str = "default", loss_kwargs=None):
        ...
        Args:
            ...
            loss_kwargs: Optional Dict of (str, value) pairs that are passed to the instantiated loss
                function.
        """
        super(RNNTLoss_dep, self).__init__()
        ...
        self._loss = resolve_rnnt_loss_dep(loss_name, blank_idx=self._blank, loss_kwargs=loss_kwargs)
