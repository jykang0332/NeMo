...
__all__ = [
    'AudioToCharDataset_SelfAttn',
    'AudioToBPEDataset_SelfAttn',
    'TarredAudioToCharDataset',
    'TarredAudioToBPEDataset',
]


def _speech_collate_fn_SelfAttn(batch, pad_id):
...
class _AudioTextDataset_SelfAttn(Dataset):
    """
    ...
    def output_types(self) -> Optional[Dict[str, NeuralType]]:
        ...
        return {
            ...
            "self_attn": NeuralType(('B', 'H', 'T', 'T'), ProbsType()),
    ...
    def _collate_fn(self, batch):
        return _speech_collate_fn_SelfAttn(batch, pad_id=self.manifest_processor.pad_id)


class AudioToCharDataset_SelfAttn(_AudioTextDataset_SelfAttn):
    """
...
class AudioToBPEDataset_SelfAttn(_AudioTextDataset_SelfAttn):
    """
    Dataset that loads tensors via a json file containing paths to audio
    files, transcripts, and durations (in seconds). Each new line is a
    different sample. Example below:
