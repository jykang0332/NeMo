...
__all__ = ['EncDecCTCModelBPE_qkv']


class EncDecCTCModelBPE_qkv(EncDecCTCModel_qkv, ASRBPEMixin):
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = EncDecCTCModelBPE_qkv.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
