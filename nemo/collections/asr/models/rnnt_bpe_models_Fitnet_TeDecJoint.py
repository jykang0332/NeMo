...
from nemo.collections.asr.models.rnnt_models_Fitnet_TeDecJoint import EncDecRNNTModel
from nemo.collections.asr.parts.mixins import ASRBPEMixin
from nemo.core.classes.common import PretrainedModelInfo
from nemo.utils import logging, model_utils

from nemo.collections.asr.data import audio_to_text_dataset_fea_rnnt
...
class EncDecRNNTBPEModel(EncDecRNNTModel, ASRBPEMixin):
    ...
    def _setup_dataloader_from_config_fea_rnnt(self, config: Optional[Dict]):
        dataset = audio_to_text_dataset_fea_rnnt.get_audio_to_text_bpe_dataset_from_config_fea_rnnt(
            config=config,
            local_rank=self.local_rank,
            global_rank=self.global_rank,
            world_size=self.world_size,
