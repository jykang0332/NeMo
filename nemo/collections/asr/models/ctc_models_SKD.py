...
__all__ = ['EncDecCTCModel_SKD']


class EncDecCTCModel_SKD(ASRModel, ExportableEncDecModel, ASRModuleMixin, InterCTCMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.preprocessor = EncDecCTCModel_SKD.from_config_dict(self._cfg.preprocessor)
        self.encoder = EncDecCTCModel_SKD.from_config_dict(self._cfg.encoder)
        ...
        self.decoder = EncDecCTCModel_SKD.from_config_dict(self._cfg.decoder)
        ...
        if hasattr(self._cfg, 'spec_augment') and self._cfg.spec_augment is not None:
            self.spec_augmentation = EncDecCTCModel_SKD.from_config_dict(self._cfg.spec_augment)
        else:
    ...
    def change_vocabulary(self, new_vocabulary: List[str], decoding_cfg: Optional[DictConfig] = None):
        ...
        if self.decoder.vocabulary == new_vocabulary:
            ...
            del self.decoder
            self.decoder = EncDecCTCModel_SKD.from_config_dict(new_decoder_config)
            del self.loss
            self.loss = CTCLoss(
                num_classes=self.decoder.num_classes_with_blank - 1,
                zero_infinity=True,
    ...
    def _setup_dataloader_from_config(self, config: Optional[Dict]):
        ...
        audio_to_text_dataset_SKD.inject_dataloader_value_from_model_config_SKD(self.cfg, config, key='sample_rate')
        audio_to_text_dataset_SKD.inject_dataloader_value_from_model_config_SKD(self.cfg, config, key='labels')
        dataset = audio_to_text_dataset_SKD.get_audio_to_text_char_dataset_from_config_SKD(
            config=config,
    ...
    def training_step(self, batch, batch_nb):
        ...
        signal, signal_len, transcript, transcript_len, te_feature = batch
