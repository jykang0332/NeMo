...
__all__ = ['EncDecCTCModel_feature']


class EncDecCTCModel_feature(ASRModel, ExportableEncDecModel, ASRModuleMixin, InterCTCMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.preprocessor = EncDecCTCModel_feature.from_config_dict(self._cfg.preprocessor)
        self.encoder_st = EncDecCTCModel_feature.from_config_dict(self._cfg.encoder)

        # jykang
        # Define teacher
        # teacher model config file
        self.teacher_config = EncDecCTCModelBPE.from_pretrained(model_name="stt_en_conformer_ctc_large_ls").cfg
        # self.teacher_config.encoder["_target_"] = "nemo.collections.asr.modules.ConformerEncoder_feature"
        self.encoder_te = EncDecCTCModelBPE.from_config_dict(self.teacher_config.encoder)
        self.decoder_te = EncDecCTCModelBPE.from_config_dict(self.teacher_config.decoder)
        ...
        self.decoder_st = EncDecCTCModel_feature.from_config_dict(self._cfg.decoder)
        ...
        if hasattr(self._cfg, 'spec_augment') and self._cfg.spec_augment is not None:
            self.spec_augmentation = EncDecCTCModel_feature.from_config_dict(self._cfg.spec_augment)
        else:
