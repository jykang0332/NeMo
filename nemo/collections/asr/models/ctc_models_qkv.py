...
__all__ = ['EncDecCTCModel_qkv']


class EncDecCTCModel_qkv(ASRModel, ExportableEncDecModel, ASRModuleMixin, InterCTCMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.preprocessor = EncDecCTCModel_qkv.from_config_dict(self._cfg.preprocessor)
        self.encoder_st = EncDecCTCModel_qkv.from_config_dict(self._cfg.encoder)
        ...
        self.decoder_st = EncDecCTCModel_qkv.from_config_dict(self._cfg.decoder)
        ...
        if hasattr(self._cfg, 'spec_augment') and self._cfg.spec_augment is not None:
            self.spec_augmentation = EncDecCTCModel_qkv.from_config_dict(self._cfg.spec_augment)
        else:
    ...
    def _setup_dataloader_from_config(self, config: Optional[Dict]):
        ...
        dataset = audio_to_text_dataset_filename.get_audio_to_text_char_dataset_from_config_filename(
            config=config,
    ...
    def training_step(self, batch, batch_nb):
        ...
        # jykang
        # Bring filename also into the batch
        signal, signal_len, transcript, transcript_len, filename = batch


        if isinstance(batch, DALIOutputs) and batch.has_processed_signal:
            log_probs, encoded_len, _, _, _ = self.forward(
