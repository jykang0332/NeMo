...
__all__ = ['EncDecCTCModelBPE_SKD_softmax']


class EncDecCTCModelBPE_SKD_softmax(EncDecCTCModel_SKD_softmax, ASRBPEMixin):
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = EncDecCTCModelBPE_SKD_softmax.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
