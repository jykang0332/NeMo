...
__all__ = ['EncDecCTCModelBPE_SelfAttn']


class EncDecCTCModelBPE_SelfAttn(EncDecCTCModel_SelfAttn, ASRBPEMixin):
    ...
    def _setup_dataloader_from_config(self, config: Optional[Dict]):
        dataset = audio_to_text_dataset_SelfAttn.get_audio_to_text_bpe_dataset_from_config_SelfAttn(
            config=config,
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = EncDecCTCModelBPE_SelfAttn.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
