...
__all__ = ['EncDecCTCModel_KD']


class EncDecCTCModel_KD(ASRModel, ExportableEncDecModel, ASRModuleMixin, InterCTCMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.preprocessor = EncDecCTCModel_KD.from_config_dict(self._cfg.preprocessor)
        self.encoder = EncDecCTCModel_KD.from_config_dict(self._cfg.encoder)
        ...
        self.decoder = EncDecCTCModel_KD.from_config_dict(self._cfg.decoder)
        ...
        if hasattr(self._cfg, 'spec_augment') and self._cfg.spec_augment is not None:
            self.spec_augmentation = EncDecCTCModel_KD.from_config_dict(self._cfg.spec_augment)
        else:
    ...
    def change_vocabulary(self, new_vocabulary: List[str], decoding_cfg: Optional[DictConfig] = None):
        ...
        if self.decoder.vocabulary == new_vocabulary:
            ...
            del self.decoder
            self.decoder = EncDecCTCModel_KD.from_config_dict(new_decoder_config)
            del self.loss
            self.loss = CTCLoss(
                num_classes=self.decoder.num_classes_with_blank - 1,
                zero_infinity=True,
    ...
    def training_step(self, batch, batch_nb):
        ...
        # test ver
        # signal, signal_len, transcript, transcript_len, teacher_softmax, file_name = batch
        ...
        # print("student shape: ", log_probs.shape)
        # print("teacher shape: ", teacher_softmax.shape)
        ...
        loss_value = loss_value_gt + loss_value_kld
