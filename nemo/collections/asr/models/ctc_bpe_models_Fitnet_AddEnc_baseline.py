...
from nemo.collections.asr.models.ctc_models_Fitnet_AddEnc_baseline import EncDecCTCModel
from nemo.collections.asr.parts.mixins import ASRBPEMixin
from nemo.core.classes.common import PretrainedModelInfo
from nemo.utils import logging, model_utils

from nemo.collections.asr.data import audio_to_text_dataset_fea_KD
...
class EncDecCTCModelBPE(EncDecCTCModel, ASRBPEMixin):
    ...
    def _setup_dataloader_from_config_fea_KD(self, config: Optional[Dict]):
        dataset = audio_to_text_dataset_fea_KD.get_audio_to_text_bpe_dataset_from_config_fea_KD(
            config=config,
            local_rank=self.local_rank,
            global_rank=self.global_rank,
            world_size=self.world_size,
