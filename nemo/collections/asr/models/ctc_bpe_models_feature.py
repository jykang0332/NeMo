...
__all__ = ['EncDecCTCModelBPE_feature']


class EncDecCTCModelBPE_feature(EncDecCTCModel_feature, ASRBPEMixin):
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = EncDecCTCModelBPE_feature.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
