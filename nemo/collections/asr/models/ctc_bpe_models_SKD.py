...
from nemo.collections.asr.models.ctc_models_SKD import EncDecCTCModel_SKD
from nemo.collections.asr.parts.mixins import ASRBPEMixin
from nemo.core.classes.common import PretrainedModelInfo
from nemo.utils import logging, model_utils

__all__ = ['EncDecCTCModelBPE_SKD']


class EncDecCTCModelBPE_SKD(EncDecCTCModel_SKD, ASRBPEMixin):
    ...
    def _setup_dataloader_from_config(self, config: Optional[Dict]):
        dataset = audio_to_text_dataset_SKD.get_audio_to_text_bpe_dataset_from_config_SKD(
            config=config,
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = EncDecCTCModelBPE_SKD.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
