...
from nemo.collections.asr.models.ctc_models_DPO_dropout import EncDecCTCModel
from nemo.collections.asr.parts.mixins import ASRBPEMixin
from nemo.core.classes.common import PretrainedModelInfo
from nemo.utils import logging, model_utils

from nemo.collections.asr.data import audio_to_text_dataset_GT
...
class EncDecCTCModelBPE(EncDecCTCModel, ASRBPEMixin):
    ...
    def _setup_dataloader_from_config_GT(self, config: Optional[Dict]):
        dataset = audio_to_text_dataset_GT.get_audio_to_text_bpe_dataset_from_config_GT(
            config=config,
            local_rank=self.local_rank,
            global_rank=self.global_rank,
            world_size=self.world_size,
