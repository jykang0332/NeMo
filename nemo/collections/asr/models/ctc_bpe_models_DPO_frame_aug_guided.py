...
from nemo.collections.asr.models.ctc_models_DPO_frame_aug_guided import EncDecCTCModel
...
class EncDecCTCModelBPE(EncDecCTCModel, ASRBPEMixin):
    ...
    def _setup_dataloader_from_config_DPO_frame(self, config: Optional[Dict]):
