...
class EncDecRNNTModel_dep(ASRModel, ASRModuleMixin, ExportableEncDecModel):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        self.preprocessor = EncDecRNNTModel_dep.from_config_dict(self.cfg.preprocessor)
        self.encoder = EncDecRNNTModel_dep.from_config_dict(self.cfg.encoder)
        ...
        self.decoder = EncDecRNNTModel_dep.from_config_dict(self.cfg.decoder)
        self.joint = EncDecRNNTModel_dep.from_config_dict(self.cfg.joint)
        ...
        if hasattr(self.cfg, 'spec_augment') and self._cfg.spec_augment is not None:
            self.spec_augmentation = EncDecRNNTModel_dep.from_config_dict(self.cfg.spec_augment)
        else:
    ...
    def change_vocabulary(self, new_vocabulary: List[str], decoding_cfg: Optional[DictConfig] = None):
        ...
        if self.joint.vocabulary == new_vocabulary:
            ...
            del self.joint
            self.joint = EncDecRNNTModel_dep.from_config_dict(new_joint_config)

            decoder_config = self.decoder.to_config_dict()
            new_decoder_config = copy.deepcopy(decoder_config)
            new_decoder_config.vocab_size = len(new_vocabulary)
            del self.decoder
            self.decoder = EncDecRNNTModel_dep.from_config_dict(new_decoder_config)
