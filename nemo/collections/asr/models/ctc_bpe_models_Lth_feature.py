...
__all__ = ['EncDecCTCModelBPE_Lth_feature']


class EncDecCTCModelBPE_Lth_feature(EncDecCTCModel_Lth_feature, ASRBPEMixin):
    ...
    def _setup_dataloader_from_config(self, config: Optional[Dict]):
        dataset = audio_to_text_dataset_filename.get_audio_to_text_bpe_dataset_from_config_filename(
            config=config,
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = EncDecCTCModelBPE_Lth_feature.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
