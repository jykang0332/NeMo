...
__all__ = ['EncDecCTCModelBPE_SEQ_fast']


class EncDecCTCModelBPE_SEQ_fast(EncDecCTCModel_SEQ_fast, ASRBPEMixin):
    ...
    def change_vocabulary(
        ...
        del self.decoder
        self.decoder = EncDecCTCModelBPE_SEQ_fast.from_config_dict(decoder_config)
        del self.loss
        self.loss = CTCLoss(
