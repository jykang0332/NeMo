...
class EncDecCTCModel(ASRModel, ExportableEncDecModel, ASRModuleMixin, InterCTCMixin):
    ...
    def training_step(self, batch, batch_nb):
        ...
        loss_value = 0.005 * fitnet_loss + skd_loss
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx=0):
        ...
        self._wer.reset()
        metrics.update({'val_loss': loss_value, 'skd_loss': skd_loss, 'fitnet_loss': fitnet_loss, 'val_wer_num': wer_num, 'val_wer_denom': wer_denom, 'val_wer': wer})
