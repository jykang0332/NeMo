...
__all__ = ['ConformerEncoder_feature']


class ConformerEncoder_feature(NeuralModule, StreamingEncoder, Exportable, AccessMixin):
    """
...
class ConformerEncoderAdapter_feature(ConformerEncoder_feature, adapter_mixins.AdapterModuleMixin):
...
"""
if adapter_mixins.get_registered_adapter(ConformerEncoder_feature) is None:
    adapter_mixins.register_adapter(base_class=ConformerEncoder_feature, adapter_class=ConformerEncoderAdapter_feature)
